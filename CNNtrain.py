...
LOG_DIR = '/home/panxiyao/Desktop/log'
...
train,train_label = get_files('/home/panxiyao/Desktop/TrainingSet/')
train_batch, train_label_batch = get_batches(train, train_label, 64, 48, 60, 80)
train_logits = model.inference(train_batch, 60, 2)
train_loss = model.losses(train_logits, train_label_batch)

train_op = model.trainning(train_loss, 0.00001)
